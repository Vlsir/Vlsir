        ...
        modules=[
            Module(
                ...
                instances=[
                    ...
                    #
                    # ## FIXME: see `test_spice_netlist2` for why these are commented out
                    #
                    # Instance(
                    #     name="m",
                    #     module=_prim("mos"),
...
@pytest.mark.xfail(reason="#63 https://github.com/Vlsir/Vlsir/issues/63")
def test_spice_netlist2():
    """Test spice netlisting, including instantiating primitives"""
