...
goog.forwardDeclare('proto.vlsir.circuit.SpiceType');
/**
...
proto.vlsir.circuit.ExternalModule.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    spicetype: jspb.Message.getFieldWithDefault(msg, 6, 0)
  };
...
proto.vlsir.circuit.ExternalModule.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = /** @type {!proto.vlsir.circuit.SpiceType} */ (reader.readEnum());
      msg.setSpicetype(value);
      break;
    default:
      reader.skipField();
      break;
...
/**
 * optional SpiceType spicetype = 6;
 * @return {!proto.vlsir.circuit.SpiceType}
 */
proto.vlsir.circuit.ExternalModule.prototype.getSpicetype = function() {
  return /** @type {!proto.vlsir.circuit.SpiceType} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};


/**
 * @param {!proto.vlsir.circuit.SpiceType} value
 * @return {!proto.vlsir.circuit.ExternalModule} returns this
 */
proto.vlsir.circuit.ExternalModule.prototype.setSpicetype = function(value) {
