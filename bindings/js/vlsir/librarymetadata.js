...
proto.vlsir.utils.LibraryMetadata.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    cellNamesList: (f = jspb.Message.getRepeatedField(msg, 10)) == null ? undefined : f,
...
/**
 * @param {string} value
 * @return {!proto.vlsir.utils.LibraryMetadata} returns this
 */
