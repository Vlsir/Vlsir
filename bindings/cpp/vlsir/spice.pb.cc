...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SimOptions_spice_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SimOptions_spice_2eproto}, {}};
