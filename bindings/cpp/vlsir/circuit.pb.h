...
class Port PROTOBUF_FINAL :
 ...
 public:
  ...
  ::vlsir::circuit::Signal* release_signal();
...
class Connection PROTOBUF_FINAL :
 ...
 public:
  ...
  ::vlsir::circuit::Signal* release_sig();
...
public:
  ...
  Instance_ParametersEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
public:
  ...
  Instance_ConnectionsEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
inline ::vlsir::circuit::Signal* Port::_internal_mutable_signal() {
  ...
  if (signal_ == nullptr) {
    auto* p = CreateMaybeMessage<::vlsir::circuit::Signal>(GetArena());
    signal_ = p;
  }
  return signal_;
}
...
inline ::vlsir::circuit::Signal* Connection::_internal_mutable_sig() {
  if (!_internal_has_sig()) {
    clear_stype();
    set_has_sig();
    stype_.sig_ = CreateMaybeMessage< ::vlsir::circuit::Signal >(GetArena());
  }
  return stype_.sig_;
}
