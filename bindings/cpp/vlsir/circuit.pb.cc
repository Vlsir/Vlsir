...
constexpr ParameterValue::ParameterValue(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : _oneof_case_{}{}
struct ParameterValueDefaultTypeInternal {
  constexpr ParameterValueDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ParameterValueDefaultTypeInternal _ParameterValue_default_instance_;
...
void ParameterValue::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<ParameterValue *>(to)->MergeFrom(
      static_cast<const ParameterValue &>(from));
}
...
void Slice::InternalSwap(Slice* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &signal_, GetArenaForAllocation(),
      &other->signal_, other->GetArenaForAllocation()
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
...
::PROTOBUF_NAMESPACE_ID::Metadata ExternalModule::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_circuit_2eproto_getter, &descriptor_table_circuit_2eproto_once,
      file_level_metadata_circuit_2eproto[12]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Interface::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_circuit_2eproto_getter, &descriptor_table_circuit_2eproto_once,
      file_level_metadata_circuit_2eproto[13]);
}
