...
extern PROTOBUF_INTERNAL_EXPORT_circuit_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Concat_circuit_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_circuit_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Connection_circuit_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_circuit_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<4> scc_info_ExternalModule_circuit_2eproto;
...
extern PROTOBUF_INTERNAL_EXPORT_circuit_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Port_circuit_2eproto;
...
class ConnectionTargetDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ConnectionTarget> _instance;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Concat_circuit_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Concat_circuit_2eproto}, {
      &scc_info_Slice_circuit_2eproto.base,}};

static void InitDefaultsscc_info_Connection_circuit_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Connection_circuit_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Connection_circuit_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<4> scc_info_ExternalModule_circuit_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 4, 0, InitDefaultsscc_info_ExternalModule_circuit_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_Instance_circuit_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_Instance_circuit_2eproto}, {
      ...
      &scc_info_Param_utils_2eproto.base,
      &scc_info_Connection_circuit_2eproto.base,}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Port_circuit_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Port_circuit_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_circuit_2eproto_sccs[10] = {
  &scc_info_Concat_circuit_2eproto.base,
  &scc_info_Connection_circuit_2eproto.base,
  &scc_info_ExternalModule_circuit_2eproto.base,
  &scc_info_Instance_circuit_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_circuit_2eproto = {
  false, false, descriptor_table_protodef_circuit_2eproto, "circuit.proto", 1264,
  &descriptor_table_circuit_2eproto_once, descriptor_table_circuit_2eproto_sccs, descriptor_table_circuit_2eproto_deps, 10, 1,
  schemas, file_default_instances, TableStruct_circuit_2eproto::offsets,
  file_level_metadata_circuit_2eproto, 11, file_level_enum_descriptors_circuit_2eproto, file_level_service_descriptors_circuit_2eproto,
};
...
::PROTOBUF_NAMESPACE_ID::uint8* ConnectionTarget::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void ConnectionTarget::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:vlsir.circuit.ConnectionTarget)
  GOOGLE_DCHECK_NE(&from, this);
  const ConnectionTarget* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ConnectionTarget>(
          &from);
  if (source == nullptr) {
...
void ConnectionTarget::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
Connection::Connection(const Connection& from)
  ...
  if (!from._internal_portname().empty()) {
    portname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_portname(),
      GetArena());
  }
...
void Connection::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Connection_circuit_2eproto.base);
  portname_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  target_ = nullptr;
}
