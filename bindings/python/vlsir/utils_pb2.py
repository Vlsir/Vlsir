...
_PREFIXED = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="int64_value",
            full_name="vlsir.utils.Prefixed.int64_value",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="double_value",
            full_name="vlsir.utils.Prefixed.double_value",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="string_value",
            full_name="vlsir.utils.Prefixed.string_value",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
_PARAMVALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="bool_value",
            full_name="vlsir.utils.ParamValue.bool_value",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="int64_value",
            full_name="vlsir.utils.ParamValue.int64_value",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="double_value",
            full_name="vlsir.utils.ParamValue.double_value",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="string_value",
            full_name="vlsir.utils.ParamValue.string_value",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
_PREFIXED.oneofs_by_name["number"].fields.append(
    _PREFIXED.fields_by_name["int64_value"]
)
_PREFIXED.fields_by_name["int64_value"].containing_oneof = _PREFIXED.oneofs_by_name[
    "number"
]
_PREFIXED.oneofs_by_name["number"].fields.append(
    _PREFIXED.fields_by_name["double_value"]
)
_PREFIXED.fields_by_name["double_value"].containing_oneof = _PREFIXED.oneofs_by_name[
    "number"
]
_PREFIXED.oneofs_by_name["number"].fields.append(
    _PREFIXED.fields_by_name["string_value"]
)
_PREFIXED.fields_by_name["string_value"].containing_oneof = _PREFIXED.oneofs_by_name[
    "number"
]
...
_PARAMVALUE.fields_by_name["bool_value"].containing_oneof = _PARAMVALUE.oneofs_by_name[
    "value"
]
_PARAMVALUE.oneofs_by_name["value"].fields.append(
    _PARAMVALUE.fields_by_name["int64_value"]
)
_PARAMVALUE.fields_by_name["int64_value"].containing_oneof = _PARAMVALUE.oneofs_by_name[
    "value"
]
_PARAMVALUE.oneofs_by_name["value"].fields.append(
    _PARAMVALUE.fields_by_name["double_value"]
)
_PARAMVALUE.fields_by_name[
    "double_value"
].containing_oneof = _PARAMVALUE.oneofs_by_name["value"]
_PARAMVALUE.oneofs_by_name["value"].fields.append(
    _PARAMVALUE.fields_by_name["string_value"]
)
_PARAMVALUE.fields_by_name[
    "string_value"
].containing_oneof = _PARAMVALUE.oneofs_by_name["value"]
