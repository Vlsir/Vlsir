...
_NOISERESULT_INTEGRATEDNOISEENTRY = _NOISERESULT.nested_types_by_name['IntegratedNoiseEntry']
...
NoiseResult = _reflection.GeneratedProtocolMessageType('NoiseResult', (_message.Message,), {

  'IntegratedNoiseEntry' : _reflection.GeneratedProtocolMessageType('IntegratedNoiseEntry', (_message.Message,), {
