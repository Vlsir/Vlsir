...
_PARAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="vlsir.spice.Param.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="val",
            full_name="vlsir.spice.Param.val",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_CONTROL.fields_by_name["param"].message_type = _PARAM
